...
// Función para encontrar la función de partición
...
func main() {
	...
	outputFile, err := os.Create("quick_sort_times.txt")
	if err != nil {
	...
	fmt.Println("Experimentos completados y resultados guardados en 'quick_sort_times.txt'")
}
